...
const ReservationTrajet = () => {
    return (
      <div className="relative w-full h-full">
        ...
        <div>
          <div className="absolute top-[200px] left-0 mt-96 ml-10 w-1/2 justify-center">
            ...
            <button
                  type="submit"
                  className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2.5 px-80 mb-3 mt-6 rounded focus:outline-none focus:shadow-outline"> Continue
            </button>
          </div>
        </div>
      </div>
